 ...
 */
export function useTableContext<T = Record<string, unknown>>(): TableContextValue<T> | null {
 ...
 */
export function useTableContextStrict<T = Record<string, unknown>>(): TableContextValue<T> {
