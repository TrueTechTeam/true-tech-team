import React, { useState, useId, useCallback, useEffect, useRef, type ReactNode } from 'react';
...
export const Checkbox = ({
  ...
  const renderIcon = (icon: React.ReactNode | IconName | undefined, defaultIcon?: IconName) => {
    ...
    if (typeof iconToRender === 'string') {
      return <Icon name={iconToRender as IconName} size={getIconSize()} className={styles.icon} />;
    }
