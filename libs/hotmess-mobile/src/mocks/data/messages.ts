...
export const mockMessages: Record<string, MockMessage[]> = {
  'thread-team-001': [
    {
      id: 'msg-001',
      thread_id: 'thread-team-001',
      sender_id: 'mock-captain-001',
      sender_name: 'Casey',
      content: 'Hey team! Ready for this Saturday?',
    ...
    },
    {
      ...
      sender_id: 'user-0002',
      sender_name: 'Mary',
      content: 'Yes! What time should we get there?',
    ...
    },
    {
      ...
      sender_id: 'mock-captain-001',
      sender_name: 'Casey',
      content: 'Game is at 10am, warm up at 9:30',
    ...
    },
    {
      ...
      sender_id: 'user-0003',
      sender_name: 'Robert',
      content: 'I will be a few minutes late, save me a spot!',
    ...
    },
    {
      ...
      sender_id: 'mock-captain-001',
      sender_name: 'Casey',
      content: 'See everyone Saturday at East Park!',
  ...
  'thread-captains-001': [
    {
      id: 'msg-010',
      thread_id: 'thread-captains-001',
      sender_id: 'mock-manager-001',
      sender_name: 'Morgan',
      content: 'Captains, roster lock deadline is this Friday at midnight.',
    ...
    },
    {
      ...
      sender_id: 'mock-manager-001',
      sender_name: 'Morgan',
      content: 'Reminder: roster lock deadline is Friday',
      created_at: new Date(Date.now() - 86400000).toISOString(),
    },
  ],
  'thread-refs-001': [
    {
      id: 'msg-030',
      thread_id: 'thread-refs-001',
      sender_id: 'mock-manager-001',
      sender_name: 'Morgan',
      content: 'Welcome to the Nashville refs chat! Use this for scheduling and questions.',
      created_at: new Date(Date.now() - 604800000).toISOString(),
    },
    {
      id: 'msg-031',
      thread_id: 'thread-refs-001',
      sender_id: 'mock-referee-001',
      sender_name: 'Riley',
      content: 'Thanks! Quick question - do we need to arrive 15 min early?',
    ...
    },
    {
      ...
      sender_id: 'mock-manager-001',
      sender_name: 'Morgan',
      content: 'Updated rulebook is posted. Check the dodgeball section.',
      created_at: new Date(Date.now() - 172800000).toISOString(),
    },
  ],
  'thread-announce-001': [
    {
      id: 'msg-020',
      thread_id: 'thread-announce-001',
      sender_id: 'mock-manager-001',
      sender_name: 'Hotmess Sports',
      content: 'Week 3 schedule is now live! Check your games.',
    ...
    },
    {
      ...
      sender_name: 'Hotmess Sports',
      content:
        'Rain policy: Games will be played unless lightning is present. Check weather updates on game day.',
