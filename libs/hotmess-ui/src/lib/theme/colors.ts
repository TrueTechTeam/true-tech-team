/**
 * Hotmess Sports brand colors.
 * Dark multi-colored palette.
 */
export const colors = {
  ...
  // Secondary - vibrant orange/red for sports energy
  secondary: {
    50: '#fff7ed',
    100: '#ffedd5',
    200: '#fed7aa',
...
/**
 * Sport-specific colors for visual differentiation.
 */
