...
const TEAM_NAMES = [
  ...
  // Expanded team names
  'Pushover Legends', 'Booze on First', 'Kick in a Box', 'The Salty Dogs', 'Beer Pressure',
  'Aggressive Napping', 'Goal Diggers', 'Saved by the Ball', 'Scrambled Legs', 'New Kids on the Block Party',
  'Back That Pass Up', 'Resting Pitch Face', 'Bocce Ballers', 'Don\'t Stop Ballieving', 'Net Worth',
  'The Mighty Drunks', 'Sofa King Good', 'Pint Sized', 'Brew Crew', 'The Big Lebowlskis',
  'Spare Me', 'Holy Rollers', 'Split Happens', 'Alley-Oops', 'The Gutter Gang',
  'Notorious D.I.G.', 'Tequila Mockingbird', 'Whiskey Business', 'Nacho Average Team', 'Sons of Pitches',
  'Just Here for the Beer', 'Permission to Spike', 'The Kicksiders', 'Foul Play', 'Ball is Life',
  'Rolling Thunder', 'The Jagernauts', 'You Got Served', 'That\'s What She Set', 'Hits and Giggles',
];
...
export const mockTeams = mockDivisions.flatMap((division, divIdx) => {
  // 4-6 teams per division, determined by division index
  const teamCount = 4 + (divIdx % 3); // cycles 4, 5, 6

  return Array.from({ length: teamCount }, (_, teamInDiv) => {
    ...
    // ~30% of teams request free agents (1-3)
