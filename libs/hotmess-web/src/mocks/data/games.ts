...
// Build a map of division_id -> teams for quick lookups
...
// Generate scheduled (future) games
const scheduledGames = Array.from({ length: 30 }, (_, i) => {
  // Pick a division that has teams
...
// Generate completed (past) games with scores
