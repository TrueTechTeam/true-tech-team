  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#kb-c)">
        ...
        <path
          d="M1 10.5Q6 9 12 9t11 1.5"
          stroke="#7f1d1d"
          strokeWidth="1.5"
          fill="none"
        />
        <path
          d="M1 13.5Q6 15 12 15t11-1.5"
          stroke="#7f1d1d"
          strokeWidth="1.5"
          fill="none"
        />
        {/* Perpendicular seam */}
        <path
          d="M10.5 1Q9 6 9 12t1.5 11"
          stroke="#7f1d1d"
          strokeWidth="1.5"
          fill="none"
        />
        <path
          d="M13.5 1Q15 6 15 12t-1.5 11"
          stroke="#7f1d1d"
          strokeWidth="1.5"
          fill="none"
        />
      ...
      {/* Shine */}
      <ellipse cx="8" cy="7" rx="3" ry="1.5" transform="rotate(-30 8 7)" fill="white" opacity="0.18" />
    </svg>
  );
}
