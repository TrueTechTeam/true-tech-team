...
// 15 — Consulting Metrics-Forward: all bullets get a slightly bolder,
// tighter treatment plus a distinct accent-colored marker (no fragile
// number/percentage parsing) to evoke a metrics-forward feel uniformly.
              ...
              {entry.bullets.length > 0 && (
                <ul className={styles.bullets}>
                  {entry.bullets.map((bullet, _) => (
                    <li key={bullet} className={styles.impactBullet}>
                      {bullet}
                    </li>
                  ))}
                </ul>
