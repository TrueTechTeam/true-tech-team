...
// Technical Monospace-Accent: section headers and the skills list use a
// monospace stack for a terminal/code feel, while body copy (summary,
// bullets) stays in a readable sans-serif so long-form content still scans
// easily. Dates are styled like inline code comments.
