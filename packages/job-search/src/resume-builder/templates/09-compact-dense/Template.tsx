...
// Compact Dense: standard section order, but every dimension (font size,
// line-height, spacing) is tightened to maximize how much fits on one page
// for candidates with a long history — without sacrificing legibility.
