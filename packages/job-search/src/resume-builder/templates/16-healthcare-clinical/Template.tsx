...
// Healthcare/Clinical template. Certifications & Licensure is promoted ahead
// of Technical Skills (right after the header/summary) and styled as a
// bordered, higher-weight block, since licensure is often the first thing a
// clinical hiring manager screens for. Experience and Education keep the
// standard relative order.
    ...
    <div className={styles.resume}>
      ...
      {certifications.length > 0 && (
        <section className={`${styles.section} ${styles.certSection}`}>
          <h2 className={styles.certSectionTitle}>Certifications &amp; Licensure</h2>
