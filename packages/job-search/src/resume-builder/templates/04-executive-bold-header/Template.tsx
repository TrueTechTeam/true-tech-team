...
// 04-executive-bold-header — Executive Bold Header
// A large, bold, business-forward header band with a strong color bar
// beneath it, then a traditional single-column body that emphasizes career
// progression: experience is the most prominent section, and dates render
