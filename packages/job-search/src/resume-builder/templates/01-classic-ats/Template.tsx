...
// 01-classic-ats — Classic Single-Column ATS
// The reference/default template: single column, minimal color, no tables or
// multi-column CSS, no graphics. Built to be the safest possible parse for
// any ATS resume scanner.
